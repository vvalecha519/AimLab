...
namespace Unity.FPS.Gameplay
{
    public class PlayerInputHandler : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            countText.text = "Bullets Fired: " + Globals.bulletsFired.ToString();
            Globals.targetsDestroyed = 0;
        }

        void Update()
        {
            targetCounterText.text = "Targets Hit: " + Globals.targetsDestroyed.ToString();
        }
        ...
        public void IncrementCounter(int bulletsNo){
            Globals.bulletsFired += bulletsNo;
            countText.text = "Bullets Fired: " + Globals.bulletsFired.ToString();
        }
